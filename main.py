...
class Anime_Info(ft.Container):
    ...
    def get_anime(self, id):
        ...
        for attempt in range(max_retries):
            try:
                ...
                #self.trailer_video.content = ft.Video(aspect_ratio=16/9, autoplay=False, filter_quality=ft.FilterQuality.NONE, muted=False, playlist=ft.VideoMedia(resource=data["data"]["trailer"]["url"]))                     # Trailer
    ...
    def add_to_list(self, e):
        ...
        dossier = r"C:\Users\Abdoul Karim\Desktop\Nouveau dossier\scripts\Dossier"
